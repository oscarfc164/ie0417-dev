...
setup(
    name='eie_commands',
    version=find_version('lib/eie_commands/__init__.py'),
    package_dir={'': 'lib'},
    ...
    # Metadata
    author='Oscar Fallas Codero',
    author_email='oscarsteven.fallas@ucr.ac.cr',
    description=(
        'eieManager is a package for laboratory #2 of '
        'IE0417 course @ EIE, UCR'
    ),
    long_description=read('README.md'),
    long_description_content_type='text/x-rst',
    url='https://ie0417-dev-b92861.readthedocs.io/en/latest/labs/labs.html',
